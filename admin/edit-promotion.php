            ...
            <div class="edit-promotion-form">
                ...
                <form method="POST" action="edit-promotion.php?id=<?php echo $promo_id; ?>">
                    <div class="mb-3">
                        ...
                        <input type="text" name="promo_code" id="promo_code" class="form-control" value="<?php echo $row['promo_code']; ?>" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="discount_percent" id="discount_percent" class="form-control" step="0.01" value="<?php echo $row['discount_percent']; ?>">
                    </div>

                    <div class="mb-3">
                        <label for="discount_amount" class="form-label">Giảm Giá Theo Số Tiền:</label>
                        <input type="number" name="discount_amount" id="discount_amount" class="form-control" step="0.01" value="<?php echo $row['discount_amount']; ?>">
                    </div>

                    <div class="mb-3">
                        <label for="valid_from" class="form-label">Thời Gian Bắt Đầu:</label>
                        <input type="datetime-local" name="valid_from" id="valid_from" class="form-control" value="<?php echo date('Y-m-d\TH:i', strtotime($row['valid_from'])); ?>" required>
                    </div>

                    <div class="mb-3">
                        <label for="valid_to" class="form-label">Thời Gian Kết Thúc:</label>
                        <input type="datetime-local" name="valid_to" id="valid_to" class="form-control" value="<?php echo date('Y-m-d\TH:i', strtotime($row['valid_to'])); ?>" required>
                    </div>
                    ...
                    <button type="submit" name="edit_promotion" class="btn btn-success">Sửa Mã Giảm Giá</button>
