...
<section id="sidebar">
    ...
    <ul class="side-menu top">
        ...
        <!-- Danh Mục (thêm active vào mục này) -->
        <li class="<?php echo (basename($_SERVER['PHP_SELF']) == 'manage-category.php') ? 'active' : ''; ?>"><a href="manage-category.php"><i class='bx bxs-category'></i><span class="text">Danh Mục</span></a></li>
...
<!-- SIDEBAR -->
	...
	<section id="content">
			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="manage-admin.php">Danh mục</a>
						</li>
					</ul>
				</div>
		...
		<br/>
            ...
            <a href="<?php echo SITEURL; ?>add-category.php" class="button-8" role="button">Thêm Danh mục</a>
            ...
            <table class="">
                ...
                <?php 
                //Lấy và hiển thị dữ liệu từ cơ sở dữ liệu
                ...
                //Sửa lỗi số thứ tự
                $sn=1; //Tạo biến và gán giá trị là 1

                //Kiểm tra xem có dữ liệu trong cơ sở dữ liệu không
                if($count > 0)
                {
                    ...
                    <td>
                        <a href="<?php echo SITEURL; ?>update-category.php?id=<?php echo $id; ?>" class="button-5" role="button">Cập nhật</a>
                        <a href="<?php echo SITEURL; ?>delete-category.php?id=<?php echo $id; ?>&image_name=<?php echo $image_name; ?>" class="button-7" role="button">Xóa</a>
                    </td>
                </tr>
                ...
                else
                {
                    ...
                    <tr>
                        <td colspan="6"><div class="error">Chưa có danh mục nào</div></td>
                    </tr>
