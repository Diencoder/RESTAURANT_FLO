        ...
        <div class="notification">
            <div class="action notif">
                ...
                <div class="notif_menu">
                    <ul>
                        <?php
                        if ($row_stock_notif > 0 && $row_stock_notif != 1) {
                            ?>
                            <li><a href="inventory.php"><?php echo $row_stock_notif ?>&nbsp;Mặt hàng hết kho</a></li>
                            <?php
                        ...
                        if ($row_online_order_notif > 0) {
                            ?>
                            <li><a href="manage-ei-order.php"><?php echo $row_ei_order_notif ?>&nbsp;Đơn hàng Ăn tại chỗ mới</a></li>
                            <?php
                        }
                        ?>
                    </ul>
