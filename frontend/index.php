    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <h1 class="mb-4">Chào Mừng Đến Với <i class="fa fa-utensils text-primary me-2"></i>Robo Cafe</h1>
                <p class="mb-4">Robo Cafe bắt đầu hành trình của mình từ năm 2017 và đã trở thành một trong những nhà hàng nổi bật trong thành phố. Ban đầu phục vụ thức ăn nhanh tại Dhaka, 
